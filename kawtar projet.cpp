...
int main () {
	...
	*N=T;
	...
	scanf("%d",&choix);
	switch (choix) {
		case 1:afficher_bijou(b,N);break;
		case 2:afficher_bijou_fournisseur(b,N);break;
		case 3:afficher_bijoux_ayant(b,N);break;
		case 4:ajouter_bijou_selon(b,N);break;
		case 5:supprimer_bijou_selon(b,N);break;
		case 6:exit(0);break;
	}
	}while(choix!=6);
	}
